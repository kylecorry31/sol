...
class PhysicsTest {
    ...
    fun getTrajectory2D() {
        val initialVelocity =
            Speed
                .from(2670f, DistanceUnits.Feet, TimeUnits.Seconds)
                .convertTo(
        ...
        val initialVelocityVector =
            Physics.getVelocityVectorForImpact(
                Vector2(sightIn, 0f),
                initialVelocity,
        ...
        for (expected in expectedTrajectory) {
            ...
            assertEquals(
                expected.third,
                Speed
                    .from(actual.velocity.x, DistanceUnits.Meters, TimeUnits.Seconds)
                    .convertTo(
                        DistanceUnits.Feet,
                        TimeUnits.Seconds,
                    ).speed,
    ...
    fun getKineticEnergy(
        ...
        val joules =
            Physics
                .getKineticEnergy(kilograms, metersPerSecond)
                .convertTo(
                    EnergyUnits.Joules,
                ).value
