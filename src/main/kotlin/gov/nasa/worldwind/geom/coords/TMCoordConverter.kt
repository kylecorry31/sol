...
internal class TMCoordConverter {
     ...
     * @return error code
     */
    fun convertGeodeticToTransverseMercator(
        Latitude: Double,
        Longitude: Double,
    ): Long {
        ...
        if (Error_Code == TRANMERC_NO_ERROR.toLong()) { // no errors
            ...
            tmdo = (
                TranMerc_ap * TranMerc_Origin_Lat -
            ...
            t4 =
                sn * s * c5 * TranMerc_Scale_Factor *
                (
                    (
                        (61e0 - 58e0 * tan2 + tan4 + 270e0 * eta - 330e0 * tan2 * eta) + 445e0 * eta2 + 324e0 * eta3 - 680e0 * tan2 * eta2 +
                            88e0 * eta4
                    ) - 600e0 * tan2 * eta3 - 192e0 * tan2 * eta4
                ) / 720e0

            t5 = sn * s * c7 * TranMerc_Scale_Factor * (
                1385e0 - 3111e0 *
                    tan2 + 543e0 * tan4 - tan6
            ) / 40320e0
            ...
            t8 = sn * c5 * TranMerc_Scale_Factor * (
                (
                    5e0 - 18e0 * tan2 + tan4 +
                        14e0 * eta
                ) - 58e0 * tan2 * eta + 13e0 * eta2 + 4e0 * eta3 - 64e0 * tan2 * eta2 - 24e0 * tan2 * eta3
            ) / 120e0
    ...
    fun convertTransverseMercatorToGeodetic(
        ...
        if (Error_Code == TRANMERC_NO_ERROR.toLong()) {
            ...
            t11 =
                t * (5e0 + 3e0 * tan2 + eta - 4e0 * eta.pow(2.0) - 9e0 * tan2 * eta) /
                (
                    (
                        24e0 * sr * sn.pow(3.0) *
                            TranMerc_Scale_Factor.pow(
                                4.0,
                            )
                    )
                )
            t12 = (
                t * (
                    (
                        61e0 + 90e0 * tan2 + 46e0 * eta + 45e0 * tan4 - 252e0 * tan2 * eta - 3e0 * eta2 + 100e0 *
                            eta3
                    ) - 66e0 * tan2 * eta2 - (
                        90e0 * tan4
                            * eta
                    ) + 88e0 * eta4 + 225e0 * tan4 * eta2 + 84e0 * tan2 * eta3 - 192e0 * tan2 * eta4
                ) /
                    (720e0 * sr * sn.pow(5.0) * TranMerc_Scale_Factor.pow(6.0))
            )
            t13 = t * (
                1385e0 + 3633e0 * tan2 + 4095e0 * tan4 + (
                    1575e0 *
                        t.pow(6.0)
                )
            ) / (40320e0 * sr * sn.pow(7.0) * TranMerc_Scale_Factor.pow(8.0))
            this.latitude = (
                ftphi - de.pow(2.0) * t10 + de.pow(4.0) * t11 - de.pow(6.0) * t12 +
                    de.pow(8.0) * t13
            )
            ...
            t16 = (
                (
                    5e0 + 6e0 * eta + 28e0 * tan2 - 3e0 * eta2 + 8e0 * tan2 * eta + 24e0 * tan4 - 4e0 *
                        eta3
                ) + 4e0 * tan2 * eta2 + (
                    24e0 *
                        tan2 * eta3
