...
internal class HighPressureLaterPredictor : WeatherPredictor {
    override fun isLikely(factors: SolForecastFactors): Boolean {
        return (factors.weatherFront == WeatherFront.Cold && factors.pressureSystem != PressureSystem.Low) || (factors.pressureSystem == PressureSystem.High && factors.pressureTendency.characteristic == PressureCharacteristic.Steady)
    }
}
