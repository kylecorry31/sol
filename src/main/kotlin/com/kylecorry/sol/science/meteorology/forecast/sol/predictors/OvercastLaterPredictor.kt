...
internal class OvercastLaterPredictor : WeatherPredictor {
    override fun isLikely(factors: SolForecastFactors): Boolean {
        ...
        return factors.weatherFront == WeatherFront.Warm && factors.pressureSystem != PressureSystem.High || (hasCurrentCloudConditions && factors.pressureSystem == PressureSystem.Low && factors.pressureTendency.characteristic == PressureCharacteristic.Steady)
    }
}