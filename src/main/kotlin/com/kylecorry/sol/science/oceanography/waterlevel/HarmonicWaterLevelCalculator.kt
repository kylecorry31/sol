...
class HarmonicWaterLevelCalculator(private val harmonics: List<TidalHarmonic>) :
    ...
    companion object {
        ...
        private val corrections2025 = mutableMapOf(
            ...
            TideConstituent.TWO_N2 to Pair(0.963222492260565, 128.6644498682797),
            ...
            TideConstituent.TWO_Q1 to Pair(1.1879459793260136, 118.0531208434029),
            TideConstituent.P1 to Pair(1.0, 349.09434220685216),
            TideConstituent.TWO_SM2 to Pair(0.963222492260565, 35.42521329169835),
            ...
            TideConstituent.TWO_MK3 to Pair(1.0325192816144622, 278.44514816690327),
