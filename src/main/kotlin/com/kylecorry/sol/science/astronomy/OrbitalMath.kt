...
internal object OrbitalMath {
    ...
    fun getEclipticCoordinate(
        ...
        val heliocentricEclipticLatitude =
            asin(
                sinDegrees(heliocentricEclipticLongitude - ascendingNodeEclipticLongitude) *
                    sinDegrees(
                        inclination,
                    ),
            ).toDegrees()
    ...
    fun getRadius(
        ...
        semimajorAxis * (1 - square(eccentricity)) /
            (1 + eccentricity * cosDegrees(trueAnomaly))

    fun getTrueAnomaly(
        meanAnomaly: Double,
        equationOfCenter: Double,
    ): Double = normalizeAngle(meanAnomaly + equationOfCenter)
    ...
    fun estimateEccentricAnomaly(
        ...
        return Optimization
            .newtonRaphsonIteration(meanAnomalyRadians, tolerance = toleranceRadians) {
