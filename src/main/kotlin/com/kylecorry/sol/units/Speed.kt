...
value class Speed private constructor(
    ...
    fun convertTo(
        newDistanceUnits: DistanceUnits,
        newTimeUnits: TimeUnits,
    ): Speed {
    ...
    override fun toString(): String = "$speed $distanceUnits / $timeUnits"
    ...
    companion object {
        fun from(
            ...
            timeUnits: TimeUnits,
        ): Speed = Speed(packMeasureMultiUnit(value, distanceUnits, timeUnits))
    }
}
