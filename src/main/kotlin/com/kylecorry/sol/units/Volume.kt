...
enum class Volume(override val id: Int, override val multiplierToBase: Float) : PhysicalUnit {
    Liters(1, 1f),
    Milliliter(2, 0.001f),
    USCups(3, 0.236588f),
    USPints(4, 0.473176f),
    ...
    companion object {
        fun liters(volume: Float): Quantity<Volume> {
            return Quantity(volume, Liters)
        }
    }
}

fun Quantity<Volume>.liters(): Quantity<Volume> {
    return convertTo(Volume.Liters)
}