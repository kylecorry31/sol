...
@JvmInline
value class Temperature private constructor(
    ...
    fun celsius(): Temperature = convertTo(TemperatureUnits.Celsius)

    override fun toString(): String = "$value $units"

    override fun compareTo(other: Temperature): Int = celsius().value.compareTo(other.celsius().value)
    ...
    companion object {
        ...
        ): Temperature = Temperature(packMeasure(value, unit))

        fun celsius(temperature: Float): Temperature = from(temperature, TemperatureUnits.Celsius)

        fun fahrenheit(temperature: Float): Temperature = from(temperature, TemperatureUnits.Fahrenheit)
    }
}
