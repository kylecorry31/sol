...
data class Vector3(
    ...
    fun toFloatArray(): FloatArray = array

    fun dot(other: Vector3): Float = Vector3Utils.dot(toFloatArray(), other.toFloatArray())

    fun magnitude(): Float = Vector3Utils.magnitude(toFloatArray())
    ...
    companion object {
        ...
        fun from(arr: FloatArray): Vector3 = Vector3(arr[0], arr[1], arr[2])
    }
}
...
object Vector3Utils {
    ...
    ): FloatArray = minus(first, project(first, planeNormal))
    ...
    fun dot(
        first: FloatArray,
        second: FloatArray,
    ): Float = first[0] * second[0] + first[1] * second[1] + first[2] * second[2]

    fun magnitude(arr: FloatArray): Float = sqrt(arr[0] * arr[0] + arr[1] * arr[1] + arr[2] * arr[2])
