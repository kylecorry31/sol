...
@JvmInline
value class Vector2 internal constructor(
     ...
     */
    fun angle(): Float = normalizeAngle(atan2(y, x).toDegrees())
    ...
    fun distanceTo(other: Vector2): Float = (other - this).magnitude()

    fun squaredMagnitude(): Float = x * x + y * y

    fun squaredDistanceTo(other: Vector2): Float = (other - this).squaredMagnitude()

    fun angleBetween(other: Vector2): Float = (other - this).angle()
